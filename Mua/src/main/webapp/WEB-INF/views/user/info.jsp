...
<body>
	...
	<div class="wrapper">
		<div class="row justify-content-center">
			<form:form modelAttribute="infoUserBean" action="${root }main"
				method="get">
				<div class="input-box">
					<form:label path="user_id">좋아하는 노래는? : </form:label>
					<c:out value="despacito">
					</c:out>
				</div>
				...
				<div class="input-box">
					<form:label path="user_birthday">생년월일 : </form:label>
					<form:input path="user_birthday" readonly="true"></form:input>
				</div>

				<div class="input-box">
					<form:label path="user_registdate">가입일자 : </form:label>
				...
				<div>
					...
					<form:button type="button"
						onclick="location.href='${root}user/modify'">회원정보 수정</form:button>
				</div>
